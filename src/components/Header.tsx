      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          <Select value={language} onValueChange={handleLanguageChange}>
            ...
            <SelectContent>
              <SelectItem value="en">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" id="flag-icons-us" viewBox="0 0 640 480" class="mdl-js"><script xmlns="" id="eppiocemhmnlbhjplcgkofciiegomcon" /><script xmlns="" /><script xmlns="" />
                  <g fill-rule="evenodd">
                    <g stroke-width="1pt">
                ...
                </svg> English</SelectItem>
              <SelectItem value="vi"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" viewBox="0 0 30 20" version="1.1" class="mdl-js"><script xmlns="" id="eppiocemhmnlbhjplcgkofciiegomcon" /><script xmlns="" /><script xmlns="" />
                <rect width="30" height="20" fill="#ff0000" />
                <polygon points="15,4 11.47,14.85 20.71,8.15 9.29,8.15 18.53,14.85" fill="#ffeb00" />
              </svg> Tiếng Việt</SelectItem>
            </SelectContent>
          </Select>
